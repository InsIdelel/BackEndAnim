...
class SheepFormScreen extends StatefulWidget {
  ...
  @override
  _SheepFormScreenState createState() => _SheepFormScreenState();
}

class _SheepFormScreenState extends State<SheepFormScreen> {
  ...
  final List<String> _races = ['Mérinos', 'Suffolk', 'Texel', 'Lacaune', 'Romanov', 'Autre'];
  final List<String> _sexes = ['Mâle', 'Femelle'];
  final List<String> _couleurs = ['Blanc', 'Noir', 'Marron', 'Gris'];
